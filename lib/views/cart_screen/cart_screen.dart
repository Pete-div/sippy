            ...
            Future.delayed(const Duration(milliseconds: 500), () {
              showDialog(
                ...
                builder: (dialogContext) => AppDialog(
                  ...
                  message: 'Return Home or Continue Shopping',
                  actions: [
                    DialogAction(title: 'Cancel'),
                    DialogAction(
                      title: 'Return Home',
                      onPressed: (_) {
                        serviceLocator<CartViewModel>().clearCart();
                        Navigator.of(dialogContext)
                            .pop(); // Close the dialog first
                        AppNavigator.of(context).navigate(const HomeRoute());
                      },
                    ),
                  ],
                ),
